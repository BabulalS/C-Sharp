...
namespace ST_95f473e362c44ba9aeb60f9e842f0ebe
{
    ...
    public partial class ScriptMain : Microsoft.SqlServer.Dts.Tasks.ScriptTask.VSTARTScriptObjectModelBase
    {
        ...
        public void Main()
        {
            ...
            string strserver = "SMTP.COM";
            string constr = @"Data Source=testserver;Initial Catalog=testdb;Integrated Security=SSPI;";
            SqlConnection con = new SqlConnection(constr);
            SqlCommand cmd = new SqlCommand("select * from dbo.[tablename] order by owner", con);
        ...
        private void SendMailToManagerList()
        {
            ...
            string constr = @"Data Source=Testserver;Initial Catalog=testdb;Integrated Security=SSPI;";
            SqlConnection con = new SqlConnection(constr);
            SqlCommand cmd = new SqlCommand("select * from  dbo.testtable order by [manager name] , [required by] ,[Reporting Team]", con);
            SqlDataAdapter da = new SqlDataAdapter();
            con.Open();
            da.SelectCommand = cmd;
            DataSet ds = new DataSet();
