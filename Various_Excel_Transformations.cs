...
namespace ExcelPOC
{
	...
	public partial class ScriptMain : Microsoft.SqlServer.Dts.Tasks.ScriptTask.VSTARTScriptObjectModelBase
	{
		...
		public void Main()
		{
            //string ExcelFilePath = @"C:\somefolder\filename.xlsx";
        ...
        private void Notification_To_SQL()
        {
            ...
            string ExceltoLoad = @"C:\somefolder\somefile.xlsx";
            string SQLConnString = @"Data Source=someserver;Initial Catalog=somedb;Integrated Security=SSPI;";
        ...
        private void ExportDatatoExcel(Excel.Application ExcelApp, Excel.Workbook WB)
        {
            ...
            string query = "SELECT TOP 10 AgencyID,AgencyCode,AgencyFullName,CompanyName,Brokerall,CompanyGroupName FROM DBO.sometable";
            string connectionSql = @"Data Source=someserver;Initial Catalog=db;Integrated Security=SSPI;";            
